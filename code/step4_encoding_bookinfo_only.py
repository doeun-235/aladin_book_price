...
## step1 : encode author, author_mul, publisher
## step2 : split columns by 2digits (author, author_mul, publisher, pdate)
## (or 4digits)
## step3 : encode integer columns by numeric corpus
## step4 : encode numeric values in str columns by numeric corpus (1.split 2.encode)
## step5 : make non-numeric corpus and encode rest values in str columns
